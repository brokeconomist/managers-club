...
st.set_page_config(page_title="Ανάλυση Έκπτωσης Πίστωσης", layout="centered")
st.title("Ανάλυση Έκπτωσης για Πληρωμή τοις Μετρητοίς")

st.header("1. Εισαγωγή Παραμέτρων")
...
dso_diff = old_dso - new_dso

receivables_old = current_sales * old_dso / 365
receivables_new = total_sales * new_dso / 365
