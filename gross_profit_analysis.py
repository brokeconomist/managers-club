...
def show_gross_profit_template():
    st.write("Debug: Φόρτωσε το εργαλείο Ανάλυσης Μικτού Κέρδους")
...
def show_gross_profit_template():
    ...
    st.write("Συμπλήρωσε τις τιμές και δες τα αποτελέσματα.")

    col1, col2 = st.columns(2)

    with col1:
        τιμη_μοναδας = st.number_input("Τιμή Μονάδας (€)", value=12.00, min_value=0.0, step=0.01)
        πωλουμενες_μοναδες = st.number_input("Πωλούμενες Μονάδες", value=22500, min_value=0)
