...
st.markdown("""
Το **Managers’ Club** είναι μια διαδικτυακή πλατφόρμα που σου δίνει τη δυνατότητα να κάνεις πιο γρήγορα, πιο ξεκάθαρα και πιο τεκμηριωμένα οικονομικές επιλογές για την επιχείρησή σου ή τις σπουδές σου.
...
📄 [Δες ένα demo παράδειγμα χρήσης (Excel)](https://example.com/demo.xlsx)  
...
def show_clv_calculator():
    ...
    st.title("Πόσα χρήματα αφήνει ένας πελάτης σας; 💰")
    st.markdown("""
