...
def show_home():
    ...
    ### 🔧 Τι μπορείτε να κάνετε με το Managers’ Club:

#### 1. Βασικά Οικονομικά Εργαλεία:
...
#### 2. Ανάλυση Στρατηγικών Σεναρίων:
...
#### 3. Ανάλυση Πελατών & Χρηματοδότησης:
...
def show_break_even():
    ...
    fixed_costs = st.number_input("Σταθερά κόστη (€)", value=26000.0, min_value=0.0)
