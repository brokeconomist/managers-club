...
def show_loss_threshold_before_price_cut():
    ...
    st.markdown("""
    έριξαν την τιμή οι ανταγωνιστές και σκέφτεστε να κανετε το ίδιο;

    👉 Αυτό το εργαλείο σάς δείχνει μια εκτίμηση του **πόσες πωλήσεις μπορείτε να χάσετε** και **πάλι να βγάζετε τα ίδια λεφτά με πριν**!
