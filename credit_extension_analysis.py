...
def calculate_credit_extension_simple(
    ...
    return {
        ...
        "Formatted": {
            "Net Profit": format_euro(net_profit),
            "Total Cost from Increase": format_euro(total_cost),
            "Anticipated Gain": format_euro(anticipated_gain),
        },
        "Suggestion": "✅ Αύξησε τον Χρόνο Πίστωσης" if anticipated_gain > 0 else "❌ Μην Αυξήσεις τον Χρόνο Πίστωσης",
    }
