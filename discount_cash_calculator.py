...
def discount_cash_ui():
    ...
    with col2:
        days_accept = st.number_input("Μέρες Είσπραξης για Πελάτες με Έκπτωση", value=10)
        days_reject = st.number_input("Μέρες Είσπραξης για Υπόλοιπους Πελάτες", value=120)
